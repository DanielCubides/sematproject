...
<html>
	...
	<g:form action="save">
		<ul id="detallesTareaPanel">
			...
			<li>Nombre: <g:field id="campoTextoD1" name="name" type="text" value="${taskInstance.name}" required="" disabled="disabled" placeholder="Nombre"/></li>
			<li>Categoria: <g:field id="campoTextoD2" name="category" type="text" maxlength="2" disabled="disabled" value="${taskInstance.category}" required="" placeholder="Categoria"/></li>
			<li><div id="letraDescripcion">Descripcion:</div><li>
			<li><g:textArea id="campoTextoD3" name="description" type="text" value="${taskInstance?.description}" disabled="disabled" placeholder="Descripción"/></li>
			<li id="fechasTarea">Fecha iniciación: <g:formatDate date="${taskInstance?.startedDate}" /><li>
			<li id="fechasTarea">Fecha finalización: <g:formatDate date="${taskInstance?.finishDate}" /><li>
			<g:if test="${taskInstance.state != 2}"><li><div id="botonEditarTarea"><g:link class="edit" action="edit" id="${taskInstance?.id}">Editar</g:link></div></li></g:if>
		</ul>
	</g:form>
